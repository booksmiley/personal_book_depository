...
_EN = {
    ...
    "mb_title": "Title (required)",
    "mb_author": "Author",
    "mb_publisher": "Publisher",
    "mb_year": "Year",
    "mb_isbn": "ISBN (optional)",
    "mb_copies": "Copies",
    "mb_save": "Add to library",
    "st_manual_added": 'Added ✅ "{title}".',
    # Status line
    "st_idle": "Idle.",
    ...
    "srv_title_required": "A title is required.",
